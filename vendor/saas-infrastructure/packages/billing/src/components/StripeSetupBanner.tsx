...
import { Alert, AlertDescription, AlertTitle } from "@saas-infra/ui/alert";
      ...
      <AlertDescription className="mt-2 space-y-3">
        ...
        <div className="rounded-lg bg-muted/50 p-4 text-sm space-y-2">
          ...
          <ol className="list-decimal list-inside space-y-1 text-muted-foreground">
            <li>Go to <a href="https://dashboard.stripe.com/apikeys" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline inline-flex items-center gap-1">Stripe Dashboard &rarr; API Keys <ExternalLink className="h-3 w-3" /></a></li>
